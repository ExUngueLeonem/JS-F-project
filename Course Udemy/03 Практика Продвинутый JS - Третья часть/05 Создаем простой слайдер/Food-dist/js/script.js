...
// Timer
    ...
    // Forms отправка данных на сервер
        ...
        // =============== SLIDER
        document.addEventListener('click', OfferSlider);

        const offerSlider = document.querySelector('.offer__slider'),
              slides = offerSlider.querySelectorAll('.offer__slide'),
              spanSlideCount = offerSlider.querySelector('#current'),
              spanTotalCount = offerSlider.querySelector('#total'),
              nextBtn = offerSlider.querySelector('.offer__slider-next'),
              prevBtn = offerSlider.querySelector('.offer__slider-prev');
        ...
        function slidesTotalCount() {
            if (slides.length <= 9 ) {
                spanTotalCount.innerText = '0' + slides.length;
            } else {
                spanTotalCount.innerText = slides.length;
            }
        }
        ...
        function showSlide(slideCount) {
            ...
            if (slideCount < 8) { 
                spanSlideCount.innerText = '0' + (slideCount + 1);
            } else {
                spanSlideCount.innerText = (slideCount + 1);
            }
        }
        ...
        function nextSlide() {
            if (slideCount >= slides.length-1) slideCount = -1;
            slideCount++;
            showSlide(slideCount);
        }
